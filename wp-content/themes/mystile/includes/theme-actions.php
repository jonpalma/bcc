...
/* Homepage hook */
/*-----------------------------------------------------------------------------------*/
function mystile_homepage_featured() {
	do_action('mystile_homepage_featured');
}

function mystile_homepage_recent() {
	do_action('mystile_homepage_recent');
}

function mystile_homepage_categories() {
	do_action('mystile_homepage_categories');
}
