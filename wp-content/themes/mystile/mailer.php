<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $recipient = "angel.lujan@mixen.mx";

        // Set the email subject.
        $subject = "Contactar a $name";

        // Build the email content.
        $email_content = "Mensaje enviado desde la forma de contacto de Bridge Chemical Company\n";
        $email_content .= "Nombre/Título: $name\n";
		$email_content .= "Ciudad/Domicilio: $location\n\n";
